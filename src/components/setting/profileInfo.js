      ...
      <div>
        ...
        <Paper shadow="md" radius="lg" className={classes.main}>
          ...
          <div className={classes.wrapper}>
            ...
            <NavLink to={'/settings'}>
            <Button style={{width:"100%", backgroundColor:'green'}}>Profile Information</Button>
            </NavLink>
            ...
            <Button style={{width:"100%", marginBottom:"3.5rem", backgroundColor:'#F0F0F0', color:"black"}}>Password Settings</Button>
            </NavLink>
