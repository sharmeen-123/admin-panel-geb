      ...
      <div>
        ...
        <Paper shadow="md" radius="lg" className={classes.main}>
          ...
          <div className={classes.wrapper}>
            ...
            <Button style={{width:"100%", backgroundColor:'#F0F0F0', color:"black", flex:1}}>Profile Information</Button>
            </NavLink>
            <Button style={{width:"100%", backgroundColor:'green',flex:1}} className={classes.button}>Password Settings</Button>
