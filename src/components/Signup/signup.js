    ...
    return (
      <div>
       ...
       {msg}
              ...
              <h1 fz="lg" fw={700} className={classes.title}>
                Signup
              </h1>
              ...
              <div>
                ...
                <FileInput style={{width:"20%", margin:"0 auto", padding:"1%"}} label="Upload image" placeholder="Upload image" accept="image/png,image/jpeg" onChange={handleImageUpload} />
              </div>
            ...
            <div className={classes.contacts}>
              <img src={Bg} style={{width:"40vw", height:"150vh"}} />
            </div>
          </div>
